...
class JsonDB {
    ...
    /**
     * 
     * @param {string} relativePath the relative path of the database to the current file
     * 
     * @description
    ...
    constructor(relativePath) {
        ...
        this.pathDB = path.resolve(__dirname, this.#relativePath)
    ...
    update (data, nestedKey, filePath) {
        ...
        try {
            ...
            const nestedDepth = nestedKey.length
